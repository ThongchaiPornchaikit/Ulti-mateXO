...
homepage = Frame(main_frame,bg="#ADD8E6")

titlelbmain = Label(homepage,text="Ulti-mateXO",
                  font=("Courier New",60),
                  fg="#FF5733",
                  bg="#ADD8E6").pack(pady=80)
...
chose_frame = Frame(main_frame,bg="#ADD8E6")

#ข้อความ
heading = Label(chose_frame, text="Choose Your Mode", fg="#444444", font=("Courier New", 35), bg="#ADD8E6")
heading.pack(pady=50)

#รูปแบบปุ่ม
ButtonType = Frame(chose_frame, bg="#ADD8E6")
...
b1 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#444444",fg="white", command= lambda: b_click_general(b1))
b2 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#444444",fg="white", command= lambda: b_click_general(b2))
b3 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#444444",fg="white", command= lambda: b_click_general(b3))

b4 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#444444",fg="white", command= lambda: b_click_general(b4))
b5 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#444444",fg="white", command= lambda: b_click_general(b5))
b6 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#444444",fg="white", command= lambda: b_click_general(b6))

b7 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#444444",fg="white", command= lambda: b_click_general(b7))
b8 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#444444",fg="white", command= lambda: b_click_general(b8))
b9 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#444444",fg="white", command= lambda: b_click_general(b9))
...
general = Button(ButtonType, text="General Mode", fg="white", bg="#A9A9A9", font=("Courier New", 25), command=move_game1)
general.pack(side=TOP, pady=20)

advance = Button(ButtonType, text="Advance Mode", fg="white", bg="#A9A9A9", font=("Courier New", 25), command=start_game)
advance.pack(side=TOP, pady=30)

back = Button(ButtonType, text="Back", fg="white", bg="#A9A9A9", font=("Courier New", 25), command=back_page , width=8)
back.pack(side=TOP, pady=40)

#ปุ่มกลับไปหน้าเลือกโหมดของgamemodegeneral
back_bt_game1 = Button(game1, text="Back", fg="white", bg=colors["b"], font=("Courier New", 20), command=move_page_chose)
