...
#ข้อความ
heading = Label(chose_frame, text="Choose Your Mode", fg="white", font=("Courier New", 35,"bold"), bg="#333333")
...
b1 = Button(game1, text=" ", font=("Courier New",20,"bold"),height=4,width=8,bg="#333333",fg="white", command= lambda: b_click_general(b1))
b2 = Button(game1, text=" ", font=("Courier New",20,"bold"),height=4,width=8,bg="#333333",fg="white", command= lambda: b_click_general(b2))
b3 = Button(game1, text=" ", font=("Courier New",20,"bold"),height=4,width=8,bg="#333333",fg="white", command= lambda: b_click_general(b3))

b4 = Button(game1, text=" ", font=("Courier New",20,"bold"),height=4,width=8,bg="#333333",fg="white", command= lambda: b_click_general(b4))
b5 = Button(game1, text=" ", font=("Courier New",20,"bold"),height=4,width=8,bg="#333333",fg="white", command= lambda: b_click_general(b5))
b6 = Button(game1, text=" ", font=("Courier New",20,"bold"),height=4,width=8,bg="#333333",fg="white", command= lambda: b_click_general(b6))

b7 = Button(game1, text=" ", font=("Courier New",20,"bold"),height=4,width=8,bg="#333333",fg="white", command= lambda: b_click_general(b7))
b8 = Button(game1, text=" ", font=("Courier New",20,"bold"),height=4,width=8,bg="#333333",fg="white", command= lambda: b_click_general(b8))
b9 = Button(game1, text=" ", font=("Courier New",20,"bold"),height=4,width=8,bg="#333333",fg="white", command= lambda: b_click_general(b9))
...
general = Button(ButtonType, text="General Mode", fg="white", bg="#333333", font=("Courier New", 25,"bold"), command=move_game1)
general.pack(side=TOP, pady=20)

advance = Button(ButtonType, text="Advance Mode", fg="white", bg="#333333", font=("Courier New", 25,"bold"), command=start_game)
advance.pack(side=TOP, pady=30)

back = Button(ButtonType, text="Back", fg="white", bg="#333333", font=("Courier New", 25,"bold"), command=back_page , width=8)
back.pack(side=TOP, pady=40)

#ปุ่มกลับไปหน้าเลือกโหมดของgamemodegeneral
back_bt_game1 = Button(game1, text="Back", fg="white", bg="#333333", font=("Courier New", 20,"bold"), command=move_page_chose)
