...
homepage = Frame(main_frame,bg="#2E2E2E")

titlelbmain = Label(homepage,text="Ulti-mateXO",
                  font=("Courier New",60),
                  fg="White",
                  bg="#2E2E2E").pack(pady=80)
...
chose_frame = Frame(main_frame,bg="#2E2E2E")

#ข้อความ
heading = Label(chose_frame, text="Choose Your Mode", fg="white", font=("Courier New", 35), bg="#2E2E2E")
heading.pack(pady=50)

#รูปแบบปุ่ม
ButtonType = Frame(chose_frame, bg="#2E2E2E")
...
game1 = Frame(main_frame,bg="#2E2E2E")
...
b1 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#2E2E2E",fg="white", command= lambda: b_click_general(b1))
b2 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#2E2E2E",fg="white", command= lambda: b_click_general(b2))
b3 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#2E2E2E",fg="white", command= lambda: b_click_general(b3))

b4 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#2E2E2E",fg="white", command= lambda: b_click_general(b4))
b5 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#2E2E2E",fg="white", command= lambda: b_click_general(b5))
b6 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#2E2E2E",fg="white", command= lambda: b_click_general(b6))

b7 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#2E2E2E",fg="white", command= lambda: b_click_general(b7))
b8 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#2E2E2E",fg="white", command= lambda: b_click_general(b8))
b9 = Button(game1, text=" ", font=("Courier New",20),height=4,width=8,bg="#2E2E2E",fg="white", command= lambda: b_click_general(b9))
...
for size in sizes:
    size_buttons[size] = Button(game_frame, text=size.capitalize(),width=7,bg=colors["b"],font=("Courier New",15), fg=colors["text"], command=lambda s=size: select_size(s))  # ปุ่มเลือกขนาด
    size_buttons[size].grid(row=3, column=sizes[size]-1,pady = 15)  # วางปุ่มเลือกขนาด

replay_button = Button(game_frame, text="Replay", command=reset_game,bg=colors["highlight"], fg=colors["text"],width=7,font=("Courier New",15))  # ปุ่มรีเพลย์

turn_label = Label(game_frame, text=f"Player: {player_advand}",bg="#333333",fg=colors["text"],font=("Courier New",12))  # ป้ายเพื่อแสดงผู้เล่นปัจจุบัน
turn_label.place(relx=0.5,rely=0.85,anchor=CENTER)  # วางมันไว้ด้านล่างบอร์ดเกม

pieces_label = Label(game_frame, text=f"X Pieces: {pieces['X']}",bg="#333333",fg=colors["text"],font=("Courier New",12))  # ป้ายเพื่อแสดงจำนวนชิ้นส่วนที่เหลือ
pieces_label.place(relx=0.5,rely=0.9,anchor=CENTER)  # วางป้ายไว้ด้านล่าง

pieces_label1 = Label(game_frame, text=f"O Pieces: {pieces['O']}",bg="#333333",fg=colors["text"],font=("Courier New",12))  # ป้ายเพื่อแสดงจำนวนชิ้นส่วนที่เหลือ
...
general = Button(ButtonType, text="General Mode", fg="white", bg="#2E2E2E", font=("Courier New", 25), command=move_game1)
general.pack(side=TOP, pady=20)

advance = Button(ButtonType, text="Advance Mode", fg="white", bg="#2E2E2E", font=("Courier New", 25), command=start_game)
advance.pack(side=TOP, pady=30)

back = Button(ButtonType, text="Back", fg="white", bg="#2E2E2E", font=("Courier New", 25), command=back_page , width=8)
back.pack(side=TOP, pady=40)

#ปุ่มกลับไปหน้าเลือกโหมดของgamemodegeneral
back_bt_game1 = Button(game1, text="Back", fg="white", bg="#2E2E2E", font=("Courier New", 20), command=move_page_chose)
back_bt_game1.grid(row=3, column=1, pady=10)

#ปุ่มกลับไปหน้าเลือกโหมดของgamemodeadvand
back_bt_game2 = Button(game_frame, text="Back", fg="white",bg=colors["b"], width=7, font=("Courier New", 15), command=move_page_chose)
