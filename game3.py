...
turn_label = Label(game_frame, text=f"Player: {player_advand}",bg="#333333",fg=colors["text"],font=("Fixedsys",12,"bold"))  # ป้ายเพื่อแสดงผู้เล่นปัจจุบัน
turn_label.place(relx=0.5,rely=0.85,anchor=CENTER)  # วางมันไว้ด้านล่างบอร์ดเกม

pieces_label = Label(game_frame, text=f"X Pieces: {pieces['X']}",bg="#333333",fg=colors["text"],font=("Fixedsys",12,"bold"))  # ป้ายเพื่อแสดงจำนวนชิ้นส่วนที่เหลือ
pieces_label.place(relx=0.5,rely=0.9,anchor=CENTER)  # วางป้ายไว้ด้านล่าง

pieces_label1 = Label(game_frame, text=f"O Pieces: {pieces['O']}",bg="#333333",fg=colors["text"],font=("Fixedsys",12,"bold"))  # ป้ายเพื่อแสดงจำนวนชิ้นส่วนที่เหลือ
...
back_bt_game1.grid(row=3, column=1, pady=15)
